...
const questions = [
  ...
  {
    question: "Which type of learning is best when the number of features is too high?",
    options: [
      "Supervised learning",
  ...
  {
    question: "Which type of learning is commonly used in clustering problems?",
    options: [
      "Supervised learning",
      "Unsupervised learning",
      "Reinforcement learning",
  ...
  {
    question: "What is the first step in machine learning?",
    options: [
      "Collecting data",
      "Preparing data",
      "Choosing a model",
...
export default function Comprehension2() {
