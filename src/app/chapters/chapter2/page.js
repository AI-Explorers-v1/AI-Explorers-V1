...
export default function Chapter2() {
    ...
    return (
        <main className="chapter1-container">
            ...
            <p className="font-semibold text-title text-center text-black text-black-200 text-4xl mt-8"> AI Terms </p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-4xl mt-16"> i. Supervised vs. Unsupervised Learning</p>
            ...
            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> A short exercise, classifying supervised and unsupervised: </p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> If my model learns from labeled data, what kind of learning are you expecting? </p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> - supervised learning</p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> When the number of features  (or dimensions) in a given dataset is too high, what learning is best?</p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> - unsupervised learning</p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> What type of learning is commonly used in clustering and association problems?</p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> - unsupervised learning</p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-4xl mt-16"> ii. Supervised vs. Unsupervised Learning</p>
            ...
            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> Now you have a model that you can use to make predictions!</p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-4xl mt-16"> iii. Neural Networks</p>

            <p className="font-semibold text-title text-center text-black text-black-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> Extremely insightful 5 minute video on Neural Networks <Link href="https://www.youtube.com/watch?v=bfmFfD2RIcg" className="text-blue-500 text-decoration-line: underline">here</Link>.</p>
            ...
            <div className="relative mt-32 ml-48"> {/* Video Embedding */}
                ...
                <p className="absolute left-[600px] right-[300px] top-[70px] font-semibold text-center text-black text-title text-black-300 text-lg"> Neural Networks </p>
            </div>
            <Footer />
        </main>
    );
