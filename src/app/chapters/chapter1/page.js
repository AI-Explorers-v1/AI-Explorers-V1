...
export default function Chapter1() {
    return (
        <main>
            <Nav />
            <h1 class="font-semibold text-title text-center text-white text-7xl mt-10"> Chapter 1</h1>

            <p class="font-semibold text-title text-center text-neutral-200 text-4xl mt-8"> Introduction to AI</p>
            ...
            <div className="relative mt-32 ml-48"> {/* Video Embedding */}
                ...
                <h3 className="absolute left-[700px] top-0 font-semibold text-title text-white text-5xl"> I AM AI </h3>
                <p className="absolute left-[600px] right-[300px] top-[70px] font-semibold text-center text-title text-neutral-300 text-lg"> The powers of AI shown through NVIDIA's new AI chips.</p>
            </div>

            <p class="font-semibold text-title text-center text-neutral-200 text-4xl mt-16"> i. Chatbots and Language Processing</p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> You probably have seen or even used chatbots such as Chat-GPT, Gemini, Azure etc. These chatbots are powerful enough to understand tone, context and everyday phrases at an advanced level. But how do they work? Chatbots use Natural Language Processing (NLP), a type of Artificial Intelligence, to understand and interpret text.  </p>
            
            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> *INSERT IMAGES* </p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">
...
This data is now ready to be “trained”, which we will go into in later units; for now, think of it as a machine learning from this processed information and improving what it knows. After the model is trained, it is ready for various tasks and there is further detail about tasks <Link href="https://aws.amazon.com/what-is/nlp/#:~:text=The%20NLP%20software%20uses%20pre,units%20of%20words%20or%20phrases." class="text-blue-500 text-decoration-line: underline">here</Link>. </p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Here's a description of these techniques: </p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Tokenization breaks a sentence into individual units of words or phrases. 
Stemming and lemmatization simplify words into their root form. For example, these processes turn "starting" into "start." 
Stop word removal ensures that words that do not add significant meaning to a sentence, such as "for" and "with," are removed.”
</p>
            ...
            <p class="font-semibold text-title text-center text-neutral-200 text-4xl mt-16"> ii. Image Generation</p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> *Insert example images*</p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Image Generation is another task that is possible with Artificial Intelligence. It combines Language Processing (we talked about before) and large sets of picture data to successfully generate the specified image. You can try it yourself <Link href="https://www.imagine.art/dashboard/tool/from-text" class="text-blue-500 text-decoration-line: underline">here</Link>.</p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">“It’s important to note that AI image generators also have various limitations when it comes to generating images with precise details. While these tools are a powerful way to create visual content, they are not always perfect in their current form. The quality of the generated image can be heavily reliant on the pre-trained images that the model uses, meaning that if the data used to train the AI is not representative of the desired output, the generated image may not be accurate.” <Link href="https://www.unite.ai/beginners-guide-to-ai-image-generators/" class="text-blue-500 text-decoration-line: underline">(from)</Link></p>

            <p class="font-semibold text-title text-center text-neutral-200 text-4xl mt-16"> iii. Computer Vision</p>

            <p class="font-semibold text-title text-center text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Computer Vision has many extremely valuable applications such as facial recognition,
