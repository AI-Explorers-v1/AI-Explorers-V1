...
export default function Chapter1() {
    ...
    return (
        <main className="chapter1-container">
            ...
            <p className="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-8"> Introduction to AI</p>
            ...
            <p className="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-16"> i. Chatbots and Language Processing</p>
            ...
            <p className="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> *INSERT IMAGES* </p>

            <p className="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">
...
This data is now ready to be “trained”, which we will go into in later units; for now, think of it as a machine learning from this processed information and improving what it knows. After the model is trained, it is ready for various tasks and there is further detail about tasks <Link href="https://aws.amazon.com/what-is/nlp/#:~:text=The%20NLP%20software%20uses%20pre,units%20of%20words%20or%20phrases." className="text-blue-500 text-decoration-line: underline">here</Link>. </p>
            ...
            <p className="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Here's a description of these techniques: </p>

            <p className="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Tokenization breaks a sentence into individual units of words or phrases. 
Stemming and lemmatization simplify words into their root form. For example, these processes turn "starting" into "start." 
Stop word removal ensures that words that do not add significant meaning to a sentence, such as "for" and "with," are removed.”
</p>
            ...
            <p className="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-16"> ii. Image Generation</p>

            <p className="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> *Insert example images*</p>
            ...
            <p className="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-16"> iii. Computer Vision</p>

            <p className="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Computer Vision has many extremely valuable applications such as facial recognition,
