...
const Chapter1 = () => {
  ...
  return (
    <main className="chapter1-container min-h-screen" style={{ backgroundColor: '#E9F0FD' }}>
      <Navbar />
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-5xl font-bold text-center mb-8 text-white-900">Chapter 1: Introduction to AI</h1>
