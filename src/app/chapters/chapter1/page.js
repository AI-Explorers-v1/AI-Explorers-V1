...
export default function Chapter1() {
    return (
        <main className ="chapter1-container">
            <Nav />
            <SideNavbar />
            <h1 class="font-semibold text-title text-center text-black text-black text-7xl mt-10"> Chapter 1</h1>

            <p class="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-8"> Introduction to AI</p>
            ...
            <div className="relative mt-32 ml-48"> {/* Video Embedding */}
                ...
                <p className="absolute left-[600px] right-[300px] top-[70px] font-semibold text-center text-black text-title text-neutral-300 text-lg"> The powers of AI shown through NVIDIA's new AI chips.</p>
            </div>

            <p class="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-16"> i. Chatbots and Language Processing</p>
            ...
            <p class="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> *INSERT IMAGES* </p>

            <p class="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">
...
This data is now ready to be “trained”, which we will go into in later units; for now, think of it as a machine learning from this processed information and improving what it knows. After the model is trained, it is ready for various tasks and there is further detail about tasks <Link href="https://aws.amazon.com/what-is/nlp/#:~:text=The%20NLP%20software%20uses%20pre,units%20of%20words%20or%20phrases." class="text-blue-500 text-decoration-line: underline">here</Link>. </p>
            ...
            <p class="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Here's a description of these techniques: </p>

            <p class="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Tokenization breaks a sentence into individual units of words or phrases. 
Stemming and lemmatization simplify words into their root form. For example, these processes turn "starting" into "start." 
Stop word removal ensures that words that do not add significant meaning to a sentence, such as "for" and "with," are removed.”
</p>
            ...
            <p class="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-16"> ii. Image Generation</p>

            <p class="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose"> *Insert example images*</p>
            ...
            <p class="font-semibold text-title text-center text-black text-neutral-200 text-4xl mt-16"> iii. Computer Vision</p>

            <p class="font-semibold text-title text-center text-black text-neutral-200 text-xl mt-16 mb-20 ml-24 mr-24 leading-loose">Computer Vision has many extremely valuable applications such as facial recognition,
